...
- **SAF-41** (P0) — `context-requirements` application layer: `SubmitBusinessIdea` use case — creates a draft `RequirementDocument` from raw idea text, scoped to a `Project`'s workspace. Depends on SAF-39, SAF-40.
