...
|---|---|---|
| `postgres` (16) | SAF-11 (outbox — real), SAF-14 (repositories/RLS/partitioning — real), governance audit events | `pg_isready`, container-exec |
| `keycloak` (26, dev mode) | SAF-17 (`auth-core`'s dev adapter, still to come this sequence) and SAF-21's "authenticate" step | `/health/ready` on the management port (9000), container-exec |
