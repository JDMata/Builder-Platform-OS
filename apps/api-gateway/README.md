...
**No logging yet:** `no-console` is an active lint rule with no exemption for `apps/*`, and the shared structured logger (`packages/observability`) is SAF-16's deliverable, not built yet.
